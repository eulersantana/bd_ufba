...
<body id="page-top" class="index">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="page-scroll">
                            <a href="#portfolio">Localidade</a>
                        </li>
                        <li class="page-scroll">
                            <a href="#cadastroUser">Campus</a>
                        </li>
                        <li class="page-scroll">
                            <a href="#about">Instalação</a>
                        </li>
                        <li class="page-scroll">
                            <a href="#about">Departamento</a>
                        </li>
                        <li class="page-scroll">
                            <a href="#about">Usuário</a>
                        </li>
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="file:///C|/Users/Amanda/Desktop/BD/logoUFBAConVida.png" alt="">
